...
WHERE descSituacao IN ('shipped', 'canceled')
  ...
  -- selecione todas as colunas a partir da tabela pedido aonde o pedido esteja em situação shiped ou canceled e a data seja em 2018 e a diferença entre a estimativa de entrega e a data de aprovação seja maior que 30 dias
